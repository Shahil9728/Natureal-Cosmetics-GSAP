...
requestAnimationFrame(raf);
(0, _gsapDefault.default).from(".logo img", {
    opacity: 0,
    x: -20,
    ease: Expo.easeInOut
});
(0, _gsapDefault.default).from(".row2col2img", {
    opacity: 0,
    x: 20,
    delay: 0.5,
    ease: Expo.easeInOut
});
(0, _gsapCore.TweenMax).from(".row2col1 h1", 1, {
    opacity: 0,
    delay: 0.5,
    y: 20,
    ease: Expo.easeInOut
});
(0, _gsapCore.TweenMax).from(".row2col1 p", 1, {
    opacity: 0,
    delay: 0.8,
    y: 20,
    ease: Expo.easeInOut
});
(0, _gsapCore.TweenMax).staggerFrom(".row1col2 a", 1, {
    opacity: 0,
    x: -20,
    ease: Power3.easeInOut
}, 0.08);
(0, _gsapCore.TweenMax).staggerFrom(".sect2div2content .content1", 1, {
    opacity: 0,
    y: -30,
    ease: Power3.easeInOut,
    scrollTrigger: {
...
(0, _gsapCore.TweenMax).staggerFrom(".quicklink p", 1, {
    opacity: 0,
    y: -50,
    ease: Power3.easeInOut,
    scrollTrigger: {
...
(0, _gsapCore.TweenMax).staggerFrom(".address p", 1, {
    opacity: 0,
    y: -50,
    ease: Power3.easeInOut,
    scrollTrigger: {
...
(0, _gsapCore.TweenMax).staggerFrom(".footer2 img", 1, {
    opacity: 0,
    x: -50,
    ease: Power3.easeInOut,
    scrollTrigger: {
...
(0, _gsapCore.TweenMax).staggerFrom(".footer2 p", 1, {
    opacity: 0,
    x: 50,
    ease: Power3.easeInOut,
    scrollTrigger: {
...
const t1 = (0, _gsapDefault.default).timeline({
    scrollTrigger: {
...
const glassaniamtion = (0, _gsapDefault.default).timeline({
    scrollTrigger: {
        trigger: ".sect2div2",
        scrub: 1,
        start: "top 50%",
...
glassaniamtion.fromTo("#glassimg", {
    y: 0,
    x: 0
}, {
    keyframes: {
...
const circletimeline = (0, _gsapDefault.default).timeline({
    scrollTrigger: {
        trigger: ".sect3imgdiv",
        scrub: 1,
        start: "top 70%",
...
const circletimeline1 = (0, _gsapDefault.default).timeline({
    scrollTrigger: {
        trigger: ".sect3imgdiv",
        scrub: 1,
        start: "top 70%",
...
const circletimeline2 = (0, _gsapDefault.default).timeline({
    scrollTrigger: {
        trigger: ".sect3imgdiv",
        scrub: 1,
        start: "top 70%",
...
function roundtext(radius) {
    for(i = 0; i < cursortext.length; i++){
        ...
        (0, _gsapDefault.default).set(cursortext[i], {
        ...
        let rotate = (0, _gsapDefault.default).timeline({
            repeat: -1
        });
        rotate.to(cursor, {
            rotation: 360,
...
function moveSliderLeft() {
    ...
    function scrollAnimation(currentTime) {
        ...
        } else sliderdiv.scrollLeft = targetScrollLeft;
    }
    requestAnimationFrame(scrollAnimation);
}
...
function cursormove(e) {
    ...
    m1 = (0, _gsapDefault.default).timeline();
    m1.to(cursor, {
        duration: 0.1,
        x: mouseX - radius,
        y: mouseY - radius,
    ...
    if (cursorRight) moveSliderRight();
    else if (cursorLeft) moveSliderLeft();
}
function init() {
    roundtext(radius);
...
(0, _gsapDefault.default).to(".footercircleimg", {
    top: -60,
    scrollTrigger: {
        trigger: ".footer1",
        scrub: 1,
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap/gsap-core":"05eeC"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hF8lp","igcvL"], "igcvL", "parcelRequiref81a")
